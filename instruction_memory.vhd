...
-- Initialized at time 0 from "program.txt" (one binary-encoded
...
architecture behavioral of instruction_memory is
    ...
    -- Memory initialized to NOPs; loaded from program.txt at time 0
    signal mem : mem_array := (others => NOP);
 
begin
 
    -- Load program.txt into memory at the very start of simulation (time 0)
    process
    ...
    begin
        ...
        wait; -- run once then suspend forever
    end process;
