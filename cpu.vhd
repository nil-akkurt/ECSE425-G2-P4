...
architecture behavioral of cpu is
    ...
    signal hazard_rs1 : std_logic_vector(4 downto 0);
    signal hazard_rs2 : std_logic_vector(4 downto 0);
    signal stall      : std_logic;

    signal id_uses_rs1 : std_logic;
    signal id_uses_rs2 : std_logic;

    signal insert_bubble_id_ex : std_logic;
    ...
    signal ex_alu_control_signal : std_logic_vector(3 downto 0);
    signal ex_alu_input_a        : std_logic_vector(31 downto 0);
    signal ex_alu_input_b        : std_logic_vector(31 downto 0);
    signal ex_alu_result         : std_logic_vector(31 downto 0);
    signal ex_zero               : std_logic;

    signal ex_branch_target : std_logic_vector(31 downto 0);
    signal ex_branch_taken  : std_logic;
    signal ex_store_data    : std_logic_vector(31 downto 0);

    -- EX/MEM signals
	 signal insert_bubble_ex_mem : std_logic;
    signal mem_mem_read   : std_logic;
    signal mem_mem_write  : std_logic;
    signal mem_branch     : std_logic;
    signal mem_jump       : std_logic;
    signal mem_jump_reg   : std_logic;
    ...
    signal mem_control_transfer_taken : std_logic;
...
begin
    ...
    mem_control_transfer_taken <= (mem_branch and mem_branch_taken) or mem_jump or mem_jump_reg;
    ...
    flush_if_id <= mem_control_transfer_taken;
    if_id_write_enable <= not stall;
    ...
    id_opcode <= id_instruction(6 downto 0);
    id_rd     <= id_instruction(11 downto 7);
    id_funct3 <= id_instruction(14 downto 12);
    id_rs1    <= id_instruction(19 downto 15);
    id_rs2    <= id_instruction(24 downto 20);
    id_funct7 <= id_instruction(31 downto 25);
    ...
    hazard_rs1 <= id_rs1 when id_uses_rs1 = '1' else (others => '0');
    hazard_rs2 <= id_rs2 when id_uses_rs2 = '1' else (others => '0');
    ...
    insert_bubble_id_ex <= stall or mem_control_transfer_taken;
